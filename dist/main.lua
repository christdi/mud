...
function main()
  ...
  lunac.component.inventory = lunac.component.new()
  lunac.component.location = lunac.component.new()
  lunac.component.room_ref = lunac.component.new()
  lunac.component.tag = lunac.component.new()
  lunac.component.name = lunac.component.new()
  lunac.component.room = lunac.component.new()
